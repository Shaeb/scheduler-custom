...
-->
	<div id="send_a_message_message_form">
		<form method="POST" action="../ajax/SendAMessageModule/process" id="send_a_message_form">
			...
			<textarea name="send_a_message_message" id="send_a_message_message">I would like to propose a shift trade with you.</textarea>
			<br/>
